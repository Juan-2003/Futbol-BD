...
CREATE TABLE `jugador` (
  ...
  `nombre_jugador` varchar(70) DEFAULT NULL,
  `apellido_materno` varchar(70) DEFAULT NULL,
  `apellido_paterno` varchar(70) DEFAULT NULL,
  `dorsal` int DEFAULT NULL,
  `equipo_fk` int DEFAULT NULL,
  PRIMARY KEY (`jugador_id`),
  KEY `jugador_equipo_idx` (`equipo_fk`),
  CONSTRAINT `jugador_equipo` FOREIGN KEY (`equipo_fk`) REFERENCES `equipo` (`equipo_id`)
