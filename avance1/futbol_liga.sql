...
CREATE TABLE `liga` (
  ...
  `federacion_fk` int NOT NULL,
  PRIMARY KEY (`liga_id`),
  KEY `liga_federacion_idx` (`federacion_fk`),
  CONSTRAINT `liga_federacion` FOREIGN KEY (`federacion_fk`) REFERENCES `federacion` (`federacion_id`)
